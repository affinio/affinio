...
- [x] `Phase A`: extract Pivot subsystem into dedicated runtime module.
  - module: `/Users/anton/Projects/affinio/packages/datagrid-core/src/models/pivotRuntime.ts`
...
- [x] `Phase B`: extract Tree projection subsystem (`path` / `parent` caches, subtree toggle fast-path).
  - module: `/Users/anton/Projects/affinio/packages/datagrid-core/src/models/treeProjectionRuntime.ts`
...
- [x] `Phase C`: extract Incremental aggregation adapter (`group` / `tree`, later `pivot`).
  - module: `/Users/anton/Projects/affinio/packages/datagrid-core/src/models/incrementalAggregationRuntime.ts`
  - extracted:
...
- [x] `Phase D`: keep `createClientRowModel` as orchestration shell only (state + stage wiring + lifecycle).
  - [x] extracted row runtime utility layer:
    - module: `/Users/anton/Projects/affinio/packages/datagrid-core/src/models/clientRowRuntimeUtils.ts`
    - moved patch/remap/order/reindex/versioning helpers out of `clientRowModel`.
  - [x] extracted projection primitives layer:
    - module: `/Users/anton/Projects/affinio/packages/datagrid-core/src/models/clientRowProjectionPrimitives.ts`
    - moved `filter/sort/signature/histogram` algorithms out of `clientRowModel`.
  - [x] final cleanup pass:
    - module: `/Users/anton/Projects/affinio/packages/datagrid-core/src/models/clientRowModelHelpers.ts`
