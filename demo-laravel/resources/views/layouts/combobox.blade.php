...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Affino Combobox · Livewire</title>
        ...
        <main class="select-shell">
            ...
            >
                        ...
                        <div class="overlay-panel__signal">
                            ...
                            <div>
                                <h2 class="overlay-panel__title">
                                    Combobox stack · <span data-overlay-panel-count>0</span>
                                </h2>
                                <p class="overlay-panel__copy">
                                    Track manual bridges, async loading, and pinned surfaces as the kernel balances every combobox overlay.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <ol id="overlay-panel-list" class="overlay-panel__list" data-overlay-panel-list aria-live="polite">
                    <li class="overlay-panel__empty">Stack is idle. Interact with any combobox to populate it.</li>
                </ol>
            </section>
