import { getAffinoOverlayManager } from "@affino/laravel-adapter"
...
function applyVersionBadges(root = document) {
	...
	root.querySelectorAll("[data-affino-version]").forEach((target) => targets.push(target))
	const version = `v${__AFFINO_VERSION__}`
